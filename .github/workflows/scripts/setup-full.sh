...
#sudo bash -c 'echo "[rabbitmq_management]." > /etc/rabbitmq/enabled_plugins' && sudo systemctl restart rabbitmq-server
...
pip install Cerberus!=1.3 codecov pyyaml requests_mock
